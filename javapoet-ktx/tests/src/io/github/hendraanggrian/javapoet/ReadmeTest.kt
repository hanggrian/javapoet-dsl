...
class ReadmeTest {
    ...
    @Test fun annotations() {
        ...
        assertEquals(
            """
                @io.github.hendraanggrian.javapoet.ReadmeTest.Headers(
                    accept = "application/json; charset=utf-8",
                    userAgent = "Square Cash"
                )
                public abstract io.github.hendraanggrian.javapoet.ReadmeTest.LogReceipt recordEvent(
                    io.github.hendraanggrian.javapoet.ReadmeTest.LogRecord logRecord);
        ...
        assertEquals(
            """
                @io.github.hendraanggrian.javapoet.ReadmeTest.HeaderList({
                    @io.github.hendraanggrian.javapoet.ReadmeTest.Header(name = "Accept", value = "application/json; charset=utf-8"),
                    @io.github.hendraanggrian.javapoet.ReadmeTest.Header(name = "User-Agent", value = "Square Cash")
                })
                public abstract io.github.hendraanggrian.javapoet.ReadmeTest.LogReceipt recordEvent(
                    io.github.hendraanggrian.javapoet.ReadmeTest.LogRecord logRecord);
    ...
    @Test fun javadoc() {
        assertEquals(
            """
                 ...
                 *
                 * <p>Use {@link #delete(io.github.hendraanggrian.javapoet.ReadmeTest.Conversation)} to delete the entire
                 * conversation for all participants.
                 */
                public abstract void dismiss(io.github.hendraanggrian.javapoet.ReadmeTest.Message message);
