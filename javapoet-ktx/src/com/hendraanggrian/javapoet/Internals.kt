...
@PublishedApi
internal inline fun <T> convert(format: String, args: Array<*>, action: (String, Array<*>) -> T): T = action(
    format.replace('%', '\$'),
...
/** Converts JavaPoet standard [format] and [args] to KotlinPoet. */
@PublishedApi
internal inline fun convert(format: String, args: Map<String, *>, action: (String, Map<String, *>) -> Unit): Unit =
    convert(format, args.values.toTypedArray()) { s: String, array: Array<*> ->
