...
abstract class TypeSpecContainer {
    ...
    fun addAnonymous(format: String, vararg args: Any): TypeSpec = anonymousTypeSpecOf(format, *args).also { add(it) }
    ...
    fun addAnonymous(code: CodeBlock): TypeSpec = anonymousTypeSpecOf(code).also { add(it) }
